    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "/dashboard/analytics/surveys", element: <Suspense fallback={<PageLoader />}><SurveyAnalyticsPage /></Suspense> },
          { path: "/dashboard/analytics/surveys/:surveyId", element: <Suspense fallback={<PageLoader />}><SurveyAnalyticsPage /></Suspense> },
          { path: "/dashboard/analytics/campaigns", element: <Suspense fallback={<PageLoader />}><CampaignAnalyticsPage /></Suspense> },
